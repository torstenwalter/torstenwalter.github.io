...
NAME                       TYPE                                  DATA      AGE
builder-dockercfg-vdw69    kubernetes.io/dockercfg               1         1h
builder-token-303tx        kubernetes.io/service-account-token   4         1h
builder-token-l1npj        kubernetes.io/service-account-token   4         1h
default-dockercfg-2mndj    kubernetes.io/dockercfg               1         1h
default-token-bxvrc        kubernetes.io/service-account-token   4         1h
default-token-t0c70        kubernetes.io/service-account-token   4         1h
deployer-dockercfg-7dbgn   kubernetes.io/dockercfg               1         1h
deployer-token-1r1fk       kubernetes.io/service-account-token   4         1h
deployer-token-k4qq7       kubernetes.io/service-account-token   4         1h
jenkins-cert               kubernetes.io/tls                     2         16m // <1>
----
